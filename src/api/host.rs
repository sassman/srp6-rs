...
/// Contains the client's [`PublicKey`] and their [`Proof`]
#[derive(Debug)]
#[allow(non_snake_case)]
    ...
    for Srp6<KEY_LENGTH, SALT_LENGTH>
{
    ...
    /// initially they are generated by [`generate_new_user_secrets`]
    #[allow(non_snake_case)]
    fn start_handshake(
        &self,
        user: &UserDetails,
...
impl<const KEY_LENGTH: usize, const SALT_LENGTH: usize> Handshake<KEY_LENGTH, SALT_LENGTH> {
    ...
    ) -> Result<HandshakeProof<KEY_LENGTH, SALT_LENGTH>> {
