...
- Rand 0.10 upgrade ([#24](https://github.com/sassman/srp6-rs/pull/24))

### Miscellaneous Tasks

- Update sha2 requirement from ^0.10 to ^0.11 ([#27](https://github.com/sassman/srp6-rs/pull/27))
- Update sha1 requirement from ^0.10 to ^0.11 ([#28](https://github.com/sassman/srp6-rs/pull/28))
